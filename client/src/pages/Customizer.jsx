...
import { AIPicker, FilePicker, CustomButton, ColorPicker, Tabs } from '../components';
...
const Customizer = () => {
  ...
  const handleActiveFilterTab = (tabName) => {
    switch (tabName) {
      case "logoShirt":
          state.isLogoTextrue = !activeFilterTab[tabName];
        break;
      case "stylishShirt":
          state.isFullTextrue = !activeFilterTab[tabName];
        break;
      default:
        state.isLogoTextrue = true;
        state.isFullTextrue = false;
        break;
    }
